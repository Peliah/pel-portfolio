...
const Navbar = () => {
  ...
  return (
    <nav className='flex justify-between items-center lg:h-20 h-20 border-20 bg-background cursor-pointer fixed w-full 2xl:mx-auto 2xl:container z-20' style={{color:"#FFFFFF", background:"#282C33"}}>
